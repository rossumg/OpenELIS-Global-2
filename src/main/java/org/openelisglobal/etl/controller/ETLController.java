...
import org.openelisglobal.etl.form.ETLForm;
...
public class ETLController extends BaseController {
    ...
    public ModelAndView showDictionary(HttpServletRequest request, @ModelAttribute("form") BaseForm oldForm)
        ...
        ETLForm newForm = resetSessionFormToType(oldForm, ETLForm.class);
...
//        return findForward(FWD_SUCCESS, newForm);
        return findForward(FWD_FAIL, newForm);
    }
    ...
    @RequestMapping(value = "/NextPreviousETL", method = RequestMethod.GET)
    ...
    private Dictionary setupDictionary(@Valid DictionaryForm form)
            throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    ...
    @RequestMapping(value = "/CancelETL", method = RequestMethod.GET)
